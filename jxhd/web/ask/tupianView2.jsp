   ...
   <style type="text/css">
    ...
    <script type="text/javascript">
        ...
        for (i=0;i<str.length ;i++ ){
            	str1 = str[i].split(",");
            	 for (n=0;n<str1.length ;n++ ){
        			test(id,str1[0]*ratio,str1[1]*ratio1,'red','<s:property value='#id1.name'/>',ratio2);
        }}
			 </s:if>
        ...
        function test(id,width,height,color,name,ratio){
            ...
            cans.beginPath();
            cans.arc(width,height,50*Math.sqrt(ratio),0,Math.PI*2,false);
            cans.closePath();
            cans.lineWidth = 1;
...
<%
 ...
 %>
<div class="unit fl">
<p class="lh28 pl20">姓名：<%=t_user1.getName() %> </p>
<canvas id="can<%=t_user1.getUserId() %>" width="370px" height="250px">sss</canvas>
