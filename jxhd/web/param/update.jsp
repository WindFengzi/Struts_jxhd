...
<script>
	function sub1() {
		...
		form1.action = "UpdateParam.action";
		form1.submit();
	}
	function list1() {
		history.go(-1);
...
<body>
	<form name="form1" method="post" action="ToDate.action" id="form1">
		<input type="hidden" name="t_sys_parameter.id" id="id"
			value="<s:property value='t_sys_parameter.id'/>">
					...
					<table style="width: 100%;border: 1px; border-color:#d7d7d7;"
						...
						<tr>
							...
							<td width="69%"><input type="text"
								name="t_sys_parameter.parameterName"
				...
				<div class="fr">
					<table style="width: 100%;border: 1px; border-color:#d7d7d7;"
						...
						<tr>
							...
							<td width="69%"><input type="text"
								name="t_sys_parameter.parameterValue"
								value="<s:property value='t_sys_parameter.parameterValue'/>"
								id="parameterValue" /></td>
						</tr>
						<tr>
							<td width="31%" class="bghui fb">参数描述</td>
							<td width="69%"><input type="text"
								name="t_sys_parameter.parameterDesc"
								value="<s:property value='t_sys_parameter.parameterDesc'/>"
								id="parameterDesc" /></td>
						</tr>
					</table>
				</div>
