...
<script type="text/javascript">
	...
	//选择年级后的事件
		...
		function addComment() {
			form1.target = 'frm_home_main';
			form1.action = "AddTeacherComment.action";
			form1.submit();
		}
</script>
...
<body>
	<form id="form1" name="form1" action="AdminTeacherList.action"
		method="post">
		...
		<div class="w800_con ">
			...
			<div class="form1 " style="padding-left:20px;padding-top:10px">
				...
				<input name="input" type="button" value=" 班级" onclick="chooseClassOrStudent(0)" class="bt1 fb grey1" /> 
				<input name="input" type="button" value=" 学生" onclick="chooseClassOrStudent(1)" class="bt1 fb grey1" />
				<s:if test="comment_tag == 3">
					<input type="button" value="添加" onclick="addComment();" class="bt1 fb grey1"/>
				</s:if>
			</div>
			<div class="table4 table3">
				<table style="width:100%;border:1px solid #d7d7d7"
					...
					<tr>
						...
						<td class="bghui fb">点评内容</td>
						<td class="bghui fb">班级</td>
						<s:if test="t_teacher_comment.tag == 1">
							<td width="10%" class="bghui fb">被点评学生</td>
						</s:if>
						<s:elseif test="t_teacher_comment.tag == 0">
							<td width="10%" class="bghui fb">老师</td>
						</s:elseif>
						<!-- <td width="10%" class="bghui fb">操作</td> -->
						<td width="10%" class="bghui fb">分数</td>
					</tr>
					<%
						int i = 1;
					%>
						...
						<tr>
							...
							<td>
							<s:if test="t_teacher_comment.tag == 1">
								<s:property value='studentToname' escape="false"/>
							</s:if>
							<s:elseif test="t_teacher_comment.tag == 0">
								<s:property value='name' escape="false"/>
							</s:elseif></td>
							<!-- <td><a href="#">查看</a></td> -->
							<td><s:property value='grade' escape="false"/></td>
						</tr>
					</s:iterator>
				</table>
