...
function deleteStation(evaluationId){
	if(window.confirm('你确定要删除吗？')){
		form1.action="DeleteEvaluationGroup.action";
		form1.evaluationId.value = evaluationId;
		form1.submit();
	}
}
function addStation(){
	form1.action="ToInsertEvaluationGroup.action";
	form1.submit();
}
...
<body>
	<form id="form1" name="form1" action="EvaluationGroups.action"
		method="post">
					...
					<div class="table4 table3">
						<table style="width:100%;border:1px solid #d7d7d7"
							...
							<tr>
								...
								<td width="10%" class="bghui fb">被评价组</td>
