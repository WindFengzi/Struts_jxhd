...
<script>
	function departmentByParent(departmentId) {
		...
		form1.action = "ToErrorQuestionR.action";
		form1.submit();
	}
...
<body>
	<form id="form1" name="form1" action="Departments.action" method="post">
		<input type="hidden" name="t_course_log.classId" id="departmentId" /><!-- 部门id在上面设置 -->
		<%
		...
		<div class="w800 fr">
			<iframe name='frm_home_main1' style="border:0px;" id="frm_home_main1" width=100%  height="695px" ></iframe>
		</div>
	</form>
<script>
