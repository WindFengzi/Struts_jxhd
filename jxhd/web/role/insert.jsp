...
<body>
	<form name="form1" method="post" action="ToDate.action" id="form1">
		...
		<div class="w800_con ">
			<div class="tit2">
				<h2 class="lh32 pl30">
					<span class="fb f14">添加角色信息</span> Add Role Information
				</h2>
			</div>
					...
					<table style="width: 100%;border: 1px; border-color:#d7d7d7;" class="all_content">
						<tr>
							...
							<td width="69%"><input type="text"
								name="t_sys_role.roleName" id="roleName" />
							</td>
						</tr>
				...
				<div class="fr">
					<table style="width: 100%;border: 1px; border-color:#d7d7d7;" class="all_content">
						<tr>
							...
							<td width="69%"><input type="text"
								name="t_sys_role.roleDesc" id="roleDesc" />
							</td>
						</tr>
					</table>
				</div>
