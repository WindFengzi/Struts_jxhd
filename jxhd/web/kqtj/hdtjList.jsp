...
<body>
	<form id="form1" name="form1" action="Articles.action" method="post">
		...
		<div class="w800_con ">
			<div class="tit2">
				<h2 class="lh32 pl30">
					<span class="fb f14">回答统计</span> Answer Statistics
				</h2>
			</div>
			...
			<div id='div_excel_content'>
				<div class="table4 table3">
					<table style="width: 100%;font-size:12px;border: 1px; border-color:#d7d7d7;" class="all_content">
						<tr>
							<td colspan="2" class="bghui fb">序号</td>
							<td width="12%" class="bghui fb">姓名</td>
							...
							<td width="15%" class="bghui fb">调组作答</td>
							<td width="12%" class="bghui fb">正确率</td>
						</tr>
						<%
							int i = 1;
						%>
