...
<body>
	<form name="form1" method="post" action="ToDate.action" id="form1">
		<input type="hidden" name="t_user1.userId" id="userId"
			value="<s:property value='t_user1.userId'/>"> <input
			type="hidden" name="t_user1.isTeacher" id="isTeacher" value="1" /> <input
			type="hidden" name="t_user1.departmentId" id="departmentId" />
		...
		<div class="w800_con ">
			<div class="tit2">
				<h2 class="lh32 pl30">
					<span class="fb f14">修改教师信息</span> Update Teacher Information
				</h2>
			</div>
					...
					<table style="width:370px;border-color:#d7d7d7;border:1px;">
						<tr>
							...
							<td width="69%"><input type="text" name="t_user1.loginName"
								id="loginName" value="<s:property value='t_user1.loginName'/>" />
							</td>
						</tr>
						<tr>
							<td width="31%" class="bghui fb">密码<font color='red'>(*)</font>
							</td>
							<td width="69%"><input type="password" name="t_user1.pwd1"
								id="pwd1" value="<s:property value='t_user1.pwd'/>" /></td>
						</tr>
						<tr>
							<td width="31%" class="bghui fb">确认密码<font color='red'>(*)</font>
							</td>
