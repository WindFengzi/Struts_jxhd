			...
			<div class="quan_content">
				<div class="detal">
					...
					<div class="detal_content">
						<s:property value='JXHD_SEL.question' escape="false" />
						<br /> A:
						<s:property value='JXHD_SEL.choicea' />
						<br /> B:
						<s:property value='JXHD_SEL.choiceb' />
						<br /> C:
						<s:property value='JXHD_SEL.choicec' />
						<br /> D:
						<s:property value='JXHD_SEL.choiced' />
						<br /> 答案:<input name="JXHD_QuestionPaper.useranswer" type="text"
							id="useranswer" style="width:650px;" />
					</div>
					<div class="btncase">
