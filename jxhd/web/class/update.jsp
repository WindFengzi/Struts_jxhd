...
<script>
		...
		function sub1(){
			form1.action="UpdateClass.action";
			form1.submit();
		}
		function list1(){
			history.go(-1);
...
<body>
	<form name="form1" method="post" action="ToDate.action" id="form1">
		<input type="hidden" name="t_class.classId" id="classId"
			value="<s:property value='t_class.classId'/>"> <input
			type="hidden" name="t_class.departmentId" id="departmentId"
			value="<s:property value='t_class.departmentId'/>" />
		...
		<div class="w800_con ">
			<div class="tit2">
				<h2 class="lh32 pl30">
					<span class="fb f14">添加班级信息</span> Add Student Information
				</h2>
			</div>
					...
					<table style="width: 100%;border: 1px; border-color:#d7d7d7;"
						...
						<tr>
							...
							<td width="69%"><input id="citySel" type="text" readonly
								value="<s:property value='t_class.departmentName'/>"
								onclick="showMenu();" /></td>
						</tr>
						<tr>
					...
					<table style="width: 100%;border: 1px; border-color:#d7d7d7;"
						...
						<tr>
							...
							<td width="69%"><input type="text" name="t_class.className"
								value="<s:property value='t_class.className'/>" id="className" />
							</td>
						</tr>
					</table>
				</div>
