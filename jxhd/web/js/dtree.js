...
function dTree(objName) {
	...
	this.icon = {
		root				: 'images/dot_cd1.gif',
		folder			: 'images/dot_cd1.gif',
		folderOpen	: 'images/dot_cd1.gif',
...
dTree.prototype.click = function(id) {
    var cn = this.aNodes[id];
    //ÔÚÒ³ÃæÐ´TreeNodeOnClick(cn);
    this.TreeNodeOnClick(cn);
}